...
class _ComponentLibraryLocalizationsDelegate extends LocalizationsDelegate<ComponentLibraryLocalizations> {
  ...
  Future<ComponentLibraryLocalizations> load(Locale locale) {
    return SynchronousFuture<ComponentLibraryLocalizations>(_lookupComponentLibraryLocalizations(locale));
  }
...
ComponentLibraryLocalizations _lookupComponentLibraryLocalizations(Locale locale) {
